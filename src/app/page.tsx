                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                <span className="italic">Verifiable Draws</span> is the first fully transparent random number generator, providing your applications with a verifiable source of randomness, enabling a level of security and transparency that no other solution can provide.
                            </p>
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                ...
                                <Link href="http://verify.win/bafkreicyhak2cioqb7tqtmobkzbrukxa47wx5w7k5j4slrdfli5bfi6hqi" className="text-sm font-semibold leading-6 text-gray-900">

...
const primaryFeatures = [
      ...
      },
    {
      ...
      description:
        'Our random draw algorithm runs on the Ethereum blockchain which act as a transparent computer where all the code is public and tamper-proof.',
      href: '#',
    ...
    },
    {
      ...
      description:
        'Participants have an actual proof that the winner was selected randomly because a proof of randomness is generated by the blockchain for each contest.',
      href: '#',
    ...
    return (
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            {/* <p className="mt-6 text-lg leading-8 text-gray-300">
              Here are the reasons why we are the best contest platform on the internet.
            </p> */}
          </div>
...
<div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            Participants don&apos;t trust promises that are backed by nothing but thin air, they want proofs. Start using Random.win today!
            </p>

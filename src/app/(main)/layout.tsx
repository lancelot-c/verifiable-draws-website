...
const footerNavigation = {
    ...
    social: [
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/company/random-win/',
        icon: (props: any) => (
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="bg-purple-900/90 text-center text-white fixed w-full text-sm py-2 z-10">
        <Link href="/launch-contest">
            Christmas offer: Try Random.win for <span className="font-semibold">FREE</span> until December 25 - <span className="font-semibold">Start today🎉</span>
        </Link>
    </div>
...
{/* <header className="absolute inset-x-0 top-0 z-50">
      ...
      <main>
        ...
        {/* Footer */}
<footer aria-labelledby="footer-heading" className="text-gray-400 relative">
<div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
  <div className="px-8 border-t border-white/10 pt-8 ">
    ...
    <div className="md:flex md:items-center md:justify-between">
        ...
        <div className="flex items-center justify-center sm:justify-start">
                ...
                <Link href="terms-of-use" className="text-xs hover:text-white mr-4">
                    Terms of use
                </Link>
                
                <Link href="contact" className="text-xs hover:text-white">
                    Contact
                </Link>
        </div>
